...
if isPuzzleFinished = true
{
	tempCounter = tempCounter+0.5	
}

if tempCounter >1 && tempCounter < 5
{
	audio_play_sound(Audio_Success, 10, false)
}

if mirrorTrigger1 = false && isPuzzleFinished = true
{
